...
function Features() {
  return (
    <div id='features' className='py-16 px-4 md:px-28'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
        ...
        {/* First feature */}
        <div className='rounded-3xl flex flex-col items-center bg-white'>
        ...
        {/* Second feature */}
        <div className='rounded-3xl flex flex-col items-center bg-white mt-10 md:mt-0'>
