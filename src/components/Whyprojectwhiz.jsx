...
function Whyprojectwhiz() {
  return (
    ...
    <div className='py-14 grid gap-20 items-center col-span-1 grid-cols-2 px-60'>
    {/* this is for the text */}
    <div className='bg-slate-100 rounded-3xl px-10 py-20 h-full text-slate-900'>
